...
//        TODO show user name inside the textView event_name
        event_name.setText("---add expression to show user name--------");

//        TODO show timestamp inside textView p1;
        p1.setText("---add expression to show timestamp ------");
